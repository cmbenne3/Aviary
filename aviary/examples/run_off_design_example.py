...
# Alternate Mission
prob_alternate = prob.alternate_mission(mission_range=900, wing_cargo=0, misc_cargo=12000)
...
prob_fallout = prob.fallout_mission(
    ...
    num_business=0,
    num_tourist=1,
    mission_mass=prob.get_val(av.Mission.Design.GROSS_MASS)[0],
)

print('--------------')
print('Sizing Results')
print('--------------')
print(f'Design Empty mass = {prob.get_val(av.Aircraft.Design.EMPTY_MASS)}')
print(f'Summary Operating mass = {prob.get_val(av.Mission.Summary.OPERATING_MASS)}')
print(f'Design Payload mass = {prob.get_val(av.Aircraft.CrewPayload.TOTAL_PAYLOAD_MASS)}')
print(f'Summary Zero Fuel Mass = {prob.get_val(av.Mission.Summary.ZERO_FUEL_MASS)}')
print(f'Summary Fuel Mass = {prob.get_val(av.Mission.Summary.FUEL_MASS)}')
print(f'Total Summary Fuel Mass = {prob.get_val(av.Mission.Summary.TOTAL_FUEL_MASS)}')
...
print(f'Summary Fuel Burned = {prob.get_val(av.Mission.Summary.FUEL_BURNED)}')


print('---------------')
print('Alternate Results')
print('---------------')
print(f'Design Empty mass = {prob_alternate.get_val(av.Aircraft.Design.EMPTY_MASS)}')
print(f'Summary Operating mass = {prob_alternate.get_val(av.Mission.Summary.OPERATING_MASS)}')
print(f'Design Payload mass = {prob_alternate.get_val(av.Aircraft.CrewPayload.TOTAL_PAYLOAD_MASS)}')
print(f'Summary Zero Fuel Mass = {prob_alternate.get_val(av.Mission.Summary.ZERO_FUEL_MASS)}')
print(f'Summary Fuel Mass = {prob_alternate.get_val(av.Mission.Summary.FUEL_MASS)}')
print(f'Total Summary Fuel Mass = {prob_alternate.get_val(av.Mission.Summary.TOTAL_FUEL_MASS)}')
...
print(f'Summary Fuel Burned = {prob_alternate.get_val(av.Mission.Summary.FUEL_BURNED)}')

print('---------------')
print('Fallout Results')
print('---------------')
print(f'Design Empty mass = {prob_fallout.get_val(av.Aircraft.Design.EMPTY_MASS)}')
print(f'Summary Operating mass = {prob_fallout.get_val(av.Mission.Summary.OPERATING_MASS)}')
print(f'Design Payload mass = {prob_fallout.get_val(av.Aircraft.CrewPayload.TOTAL_PAYLOAD_MASS)}')
print(f'Summary Zero Fuel Mass = {prob_fallout.get_val(av.Mission.Summary.ZERO_FUEL_MASS)}')
print(f'Summary Fuel Mass = {prob_fallout.get_val(av.Mission.Summary.FUEL_MASS)}')
print(f'Total Summary Fuel Mass = {prob_fallout.get_val(av.Mission.Summary.TOTAL_FUEL_MASS)}')
...
print(f'Summary Fuel Burned = {prob_fallout.get_val(av.Mission.Summary.FUEL_BURNED)}')
